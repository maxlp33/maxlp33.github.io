...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Use both .project-card and .slider-card so code applies to current HTML
    const projectCards = document.querySelectorAll('.project-card, .slider-card');
    ...
    // Removed unused form input handlers (no form inputs present on page) to clean up code

    // Enhanced hover effects for project/slider cards
